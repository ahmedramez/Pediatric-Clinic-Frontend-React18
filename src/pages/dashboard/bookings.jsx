    ...
    <div className="col-8">
      <div className="menu rounded">
        ...
        <div className="menu-items scrollbar-style1">
          <ul>
            <li className="menu-item position-relative book-item">
              <a
              ...
              >
                ...
                عمرو أمين على المغربى
                <p className="lead m-0 p-0 book-footer">
                  منوف - المنوفية - 01092723265
                </p>
              </a>
              <form className="book-item-form d-inline-block position-absolute text-center">
                <button
                  type="submit"
